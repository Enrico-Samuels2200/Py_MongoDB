...
#   This loop gathers all objects/dictionaries that contain the item names that are housed within item_types.
#   This loop then adds values to the dictionary items it add the key value and how many objects there are of
